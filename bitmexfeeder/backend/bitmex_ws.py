...
class BitMexWS:
    ...
    def register_handler(self, name, handler, table='orderBookL2', actions={'partial', 'insert'}):
    ...
    def __get_url(self):
        ...
        # symbol_subs = ["execution", "instrument", "order", "orderBookL2", "position", "quote", "trade"]
        symbol_subs = ["quoteBin1m", "tradeBin1m"]
        # generic_subs = ["margin"]

        # subscriptions = [sub + ':' + self.symbol for sub in symbol_subs]
        subscriptions = [sub for sub in symbol_subs]
